...
export default function mainCliente (props)
{
    console.log(props);
return(
    ...
    <ContainerH colors={['#83EEBA','#6bd1aa', '#837EBA']}>
        ...
        <Footer>
                ...
                <TouchableOpacity style={styles.buttonContainer} onPress={() => props.navigation.navigate('Logar')}>
                    <Text style={styles.buttonText}>AAAAAAAAAAAAAAAA FUNCIONA</Text>
                </TouchableOpacity>
                ...
                <Text style={styles.labelText}> Caso não tenha uma conta FUNCIONADO: </Text>
